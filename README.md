...
При первом заходе тема берётся из системной настройки, дальше запоминается выбор
пользователя (`localStorage`, ключ `theme`) — переключатель внизу навигации. Пока выбор
не сделан, сайт следует за системной темой на лету.
