...
# Всё, чего здесь нет, лежит поверх видео или не входит в нейтральную шкалу.
# Цветные роли (--surface-allow / deny / warning и их заголовки) сюда не
# добавляем намеренно: они различаются тоном, а не светлотой, и по светлоте
# как раз обязаны совпадать — это правило их семьи, а не дубль.
CONTEXT = {
    "--surface-card": "page",
